...
final class PlayedCardAtPlayer[C <: Card](val card: C, val player: Player, val targetPlayer: Player)
  extends PlayedStartingCard[C]

final class PlayedCardAtActiveCard[C <: Card](val card: C, val player: Player, val activeCard: Card)
  extends PlayedStartingCard[C]

final class PlayedCardInTree[C <: Card](val card: C, val player: Player, val parentCard: Card)
